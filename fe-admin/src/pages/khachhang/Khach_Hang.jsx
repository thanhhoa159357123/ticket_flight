...
const Khach_Hang = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-blue-700 border-b pb-2">Danh sách khách hàng</h2>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.map((user) => (
              <tr key={user.ma_khach_hang} className="transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{user.ma_khach_hang}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{user.ten_khach_hang}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{user.so_dien_thoai}</td>
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <button className="px-3 py-1 border rounded text-gray-600 hover:bg-gray-100">Trước</button>
          <button className="px-3 py-1 border rounded bg-blue-600 text-white">1</button>
          <button className="px-3 py-1 border rounded text-gray-600 hover:bg-gray-100">Sau</button>
        </div>
      </div>
    </div>
  );
