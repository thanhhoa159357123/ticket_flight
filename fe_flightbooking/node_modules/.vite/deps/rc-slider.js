...
var Range = function(_React$Component) {
  ...
  function Range2(props) {
    ...
    _this.positionGetValue = function(position) {
      ...
      if (value2 === prevValue) return null;
...
function findDOMNode2(node) {
  ...
  if (node instanceof import_react8.default.Component) {
    ...
    return (_ReactDOM$findDOMNode = import_react_dom3.default.findDOMNode) === null || _ReactDOM$findDOMNode === void 0 ? void 0 : _ReactDOM$findDOMNode.call(import_react_dom3.default, node);
  }
  return null;
}
...
function isReactElement(node) {
  return (0, import_react9.isValidElement)(node) && !isFragment(node);
}
...
function useSyncState(defaultValue) {
  var _React$useReducer = React15.useReducer(function(x) {
    return x + 1;
  }, 0), _React$useReducer2 = _slicedToArray(_React$useReducer, 2), forceUpdate = _React$useReducer2[1];
  var currentValueRef = React15.useRef(defaultValue);
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React20.forwardRef(function(props, ref) {
    ...
    var _React$useContext = React20.useContext(Context), contextMotion = _React$useContext.motion;
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component4 = component || React21.Fragment;
        var motionProps = {};
        ...
        return React21.createElement(Component4, restProps, keyEntities.map(function(_ref2, index2) {
...
var Align = function Align2(_ref, ref) {
  ...
  var _React$useState = import_react16.default.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), element = _React$useState2[0], setElement = _React$useState2[1];
  var _React$useState3 = import_react16.default.useState(), _React$useState4 = _slicedToArray(_React$useState3, 2), point = _React$useState4[0], setPoint = _React$useState4[1];
  ...
  if (import_react16.default.isValidElement(childNode)) {
    childNode = import_react16.default.cloneElement(childNode, {
      ref: composeRef(childNode.ref, nodeRef)
    });
  }
  return childNode;
};
var RcAlign = import_react16.default.forwardRef(Align);
...
var useStretchStyle_default = function(stretch) {
  ...
  var style2 = React25.useMemo(function() {
    var sizeStyle = {};
    if (stretch) {
...
// node_modules/rc-trigger/es/Popup/PopupInner.js
var PopupInner = React26.forwardRef(function(props, ref) {
  ...
  if (React26.Children.count(children) > 1) {
    childNode = React26.createElement("div", {
      className: "".concat(prefixCls, "-content")
    }, children);
  }
  return React26.createElement(es_default, _extends({
    visible,
    ref: elementRef,
    ...
    return React26.createElement(es_default2, {
...
var MobilePopupInner = React27.forwardRef(function(props, ref) {
  ...
  var childNode = children;
  if (React27.Children.count(children) > 1) {
    childNode = React27.createElement("div", {
      className: "".concat(prefixCls, "-content")
    }, children);
  }
  if (popupRender) {
  ...
  return React27.createElement(es_default, _extends({
    visible,
    ref: elementRef,
    removeOnLeave: true
...
var Popup = React28.forwardRef(function(_ref, ref) {
  ...
  var popupNode = inMobile ? React28.createElement(MobilePopupInner_default, _extends({}, cloneProps, {
    mobile,
    ref
  })) : React28.createElement(PopupInner_default, _extends({}, cloneProps, {
    ref
  }));
  return React28.createElement("div", null, React28.createElement(Mask, cloneProps), popupNode);
});
...
function generateTrigger(PortalComponent) {
  var Trigger = function(_React$Component) {
    ...
    function Trigger2(props) {
      ...
      _this = _super.call(this, props);
      _defineProperty(_assertThisInitialized(_this), "popupRef", React30.createRef());
      _defineProperty(_assertThisInitialized(_this), "triggerRef", React30.createRef());
      ...
      _defineProperty(_assertThisInitialized(_this), "getComponent", function() {
        ...
        return React30.createElement(Popup_default, _extends({
          prefixCls,
          destroyPopupOnHide,
    ...
    _createClass(Trigger2, [{
      ...
      value: function render() {
        ...
        var trigger = React30.cloneElement(child, cloneProps);
        var portal;
        if (popupVisible || this.popupRef.current || forceRender) {
          portal = React30.createElement(PortalComponent, {
            key: "portal",
        ...
        return React30.createElement(context_default.Provider, {
...
function Popup2(props) {
  ...
  return React31.createElement("div", {
    className: (0, import_classnames11.default)("".concat(prefixCls, "-content"), className),
    style: style2
  }, showArrow !== false && React31.createElement("div", {
    className: "".concat(prefixCls, "-arrow"),
    key: "arrow"
  }, arrowContent), React31.createElement("div", {
...
var Tooltip = function Tooltip2(props, ref) {
  ...
  return React32.createElement(es_default3, _extends({
...
// node_modules/rc-slider/es/common/SliderTooltip.js
var SliderTooltip = React33.forwardRef(function(props, ref) {
  var visible = props.visible, overlay = props.overlay;
  var innerRef = React33.useRef(null);
  var tooltipRef = composeRef(ref, innerRef);
  var rafRef = React33.useRef(null);
  ...
  return _a = function(_React$Component) {
    ...
    function ComponentWrapper() {
      ...
      _this.handleWithTooltip = function(_ref) {
        ...
        return import_react21.default.createElement(SliderTooltip_default, _extends({}, restTooltipProps, {
          getTooltipContainer,
          prefixCls,
          overlay,
          placement,
          ...
          key: index2
        }), import_react21.default.createElement(Handle, _extends({}, restProps, {
    ...
    _createClass(ComponentWrapper, [{
      key: "render",
      value: function render() {
        return import_react21.default.createElement(Component4, _extends({}, this.props, {
          handle: this.handleWithTooltip
        }));
      }
    }]);
    return ComponentWrapper;
  }(import_react21.default.Component), _a.defaultProps = {
